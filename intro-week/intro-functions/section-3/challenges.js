...
function readTrafficLight(str) {
  ...
  else if (str.toLowerCase() === "amber"){
    return "GET READY..."
  }
  else if (str.toLowerCase() === "green"){
    return "GO!"
  }
...
function updatePosition(arr, str) {
  ...
  /*
  This function should take an array representing coordinates - an x position and a y position - and a string representing a direction, 
  and it should return a new pair of coordinates, with the coords array updated by moving either x or y 1 unit in a particular direction
